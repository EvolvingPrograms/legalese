 ...
 * @param {{ output?: string, title?: string, baseDir?: string }} [opts]
 *   `output`  overrides the front-matter `output:` field.
 *   `title`   overrides the front-matter `title:` field.
 *   `baseDir` is used to resolve relative paths inside fenced blocks (e.g.
 *             `grids` `files:`). Defaults to the current working directory.

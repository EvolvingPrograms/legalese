// Verifies legalese's Buffer-returning entry points:
...
//
// The lower-level build / buildToBuffer parity tests live upstream
// in markdsl/src/docx/build.test.ts.

  ...
  for (let i = 0; i < inlines.length; i++) {
    ...
    switch (node.t) {
      ...
      case 'Span': {
        ...
        // Span with the class in the attribute list. We pick up Underline
        // separately above; for Span, honor the smallcaps class and
        // otherwise pass styling through unchanged.
